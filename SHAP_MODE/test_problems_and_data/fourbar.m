function Y = fourbar(X)
% Use this function to evaluate the fourbar function
% The first response is the weight of the truss system
% The second response is the displacement of the system
% Input:  X - Sampling points
% Output: Y - Responses

n = size(X,1); % Number of samples
Y = zeros(n,2); % Initiate responses
...
for ii = 1:n
    ...
    Y(ii,2) = (F*L/E)*((2/x1)+(2*sqrt(2)/x2)-(2*sqrt(2)/x3)+(2/x4));
end
